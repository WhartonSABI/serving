...
# --- Create mapping of importance -> list of associated states ---
# --- Load score importance ---
...
# --- Summarize behavior by score importance and add states column ---
...
# --- Optional: Modal location frequency at each importance ---
