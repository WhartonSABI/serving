...
wimbledon_2024 <- as.data.table(read.csv("out_data/wimbledon_2024_combined.csv"))
...
# divide male & female
wimbledon_2024_male <- wimbledon_2024[1:14888,]
wimbledon_2024_female <- wimbledon_2024[14889:nrow(wimbledon_2024),]
...
# write.csv(subset_2024_f, "out_data/wimbledon_subset_2024_f.csv", row.names = FALSE)
...
write.csv(subset_2024_m, "out_data/wimbledon_subset_2024_m.csv", row.names = FALSE)
write.csv(subset_2024_f, "out_data/wimbledon_subset_2024_f.csv", row.names = FALSE)
