...
# ## ---------------------------------------------------------------------
# 
# usopen_m_train <- as.data.table(fread("scaled/usopen_m_train_scaled.csv"))
# usopen_m_test <- as.data.table(fread("scaled/usopen_m_test_scaled.csv"))
# 
# names(usopen_m_train)
# 
# # filter ServeNumber == 2 from wimbledon_m_train
# usopen_m_train <- usopen_m_train[ServeNumber == 2]
# usopen_m_test <- usopen_m_test[ServeNumber == 2]
# 
# 
