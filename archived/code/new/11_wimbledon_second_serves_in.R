...
subset_f <- fread("../data/processed/wimbledon_subset_f.csv")
...
plot_win_prob_simple(f_second_in,
                     ...
                     save_path = "../images/in_wimbledon_female_second_speed_ratio.png")

plot_win_prob_simple(m_second_in,
                     "Male Second Serves: P(win) vs Speed Ratio",
                     save_path = "../images/in_wimbledon_male_second_speed_ratio.png")
...
plot_win_prob_simple(m_second_trimmed,
                     ...
                     save_path = "../images/in_wimbledon_male_second_ratio_middle.png")

plot_win_prob_simple(f_second_trimmed,
                     "Female Second Serves: P(win | in) vs Speed Ratio (Middle 90%)",
                     save_path = "../images/in_wimbledon_female_second_ratio_middle.png")
...
plot_win_prob_speed(f_second_in,
                    ...
                    save_path = "../images/in_wimbledon_female_second_speed_mph.png")

plot_win_prob_speed(m_second_in,
                    "Male Second Serves: P(win | in) vs Speed (MPH)",
                    save_path = "../images/in_wimbledon_male_second_speed_mph.png")
...
plot_win_prob_speed(m_second_trimmed,
                    ...
                    save_path = "../images/in_wimbledon_male_second_mph_middle.png")

plot_win_prob_speed(f_second_trimmed,
                    "Female Second Serves: P(win | in) vs Speed (MPH) (Middle 90%)",
                    save_path = "../images/in_wimbledon_female_second_mph_middle.png")
