...
write.csv(subset_2021_m, "../data/processed/wimbledon_subset_2021_m.csv", row.names = FALSE)
write.csv(subset_2021_f, "../data/processed/wimbledon_subset_2021_f.csv", row.names = FALSE)
