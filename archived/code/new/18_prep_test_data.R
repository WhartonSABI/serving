...
## usopen 2018
usopen_2018_matches <- as.data.table(read.csv("../data/sackmann/2018-usopen-matches.csv"))
colSums(is.na(usopen_2018_matches))

usopen_2018_points <- as.data.table(read.csv("../data/sackmann/2018-usopen-points.csv"))
...
usopen_2019_matches <- as.data.table(read.csv("../data/sackmann/2019-usopen-matches.csv"))
colSums(is.na(usopen_2019_matches))

usopen_2019_points <- as.data.table(read.csv("../data/sackmann/2019-usopen-points.csv"))
