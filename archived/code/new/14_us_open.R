...
usopen_2021_matches <- as.data.table(read.csv("../data/sackmann/2021-usopen-matches.csv"))
colSums(is.na(usopen_2021_matches))

usopen_2021_points <- as.data.table(read.csv("../data/sackmann/2021-usopen-points.csv"))
...
usopen_2022_matches <- as.data.table(read.csv("../data/sackmann/2022-usopen-matches.csv"))
colSums(is.na(usopen_2022_matches))

usopen_2022_points <- as.data.table(read.csv("../data/sackmann/2022-usopen-points.csv"))
...
usopen_2023_matches <- as.data.table(read.csv("../data/sackmann/2023-usopen-matches.csv"))
colSums(is.na(usopen_2023_matches))

usopen_2023_points <- as.data.table(read.csv("../data/sackmann/2023-usopen-points.csv"))
...
usopen_2024_matches <- as.data.table(read.csv("../data/sackmann/2024-usopen-matches.csv"))
colSums(is.na(usopen_2024_matches))

usopen_2024_points <- as.data.table(read.csv("../data/sackmann/2024-usopen-points.csv"))
