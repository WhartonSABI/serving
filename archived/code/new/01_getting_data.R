...
wimbledon_2011_matches <- as.data.table(read.csv("../data/sackmann/2011-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2011_matches))

wimbledon_2011_points <- as.data.table(read.csv("../data/sackmann/2011-wimbledon-points.csv"))
...
wimbledon_2012_matches <- as.data.table(read.csv("../data/sackmann/2012-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2012_matches))

wimbledon_2012_points <- as.data.table(read.csv("../data/sackmann/2012-wimbledon-points.csv"))
...
wimbledon_2013_matches <- as.data.table(read.csv("../data/sackmann/2013-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2013_matches))

wimbledon_2013_points <- as.data.table(read.csv("../data/sackmann/2013-wimbledon-points.csv"))
...
wimbledon_2014_matches <- as.data.table(read.csv("../data/sackmann/2014-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2014_matches))

wimbledon_2014_points <- as.data.table(read.csv("../data/sackmann/2014-wimbledon-points.csv"))
...
wimbledon_2015_matches <- as.data.table(read.csv("../data/sackmann/2015-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2015_matches))

wimbledon_2015_points <- as.data.table(read.csv("../data/sackmann/2015-wimbledon-points.csv"))
...
wimbledon_2016_matches <- as.data.table(read.csv("../data/sackmann/2016-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2016_matches))

wimbledon_2016_points <- as.data.table(read.csv("../data/sackmann/2016-wimbledon-points.csv"))
...
wimbledon_2017_matches <- as.data.table(read.csv("../data/sackmann/2017-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2017_matches))

wimbledon_2017_points <- as.data.table(read.csv("../data/sackmann/2017-wimbledon-points.csv"))
...
wimbledon_2018_matches <- as.data.table(read.csv("../data/sackmann/2018-wimbledon-matches.csv"))
colSums(is.na(wimbledon_2018_matches))

wimbledon_2018_points <- as.data.table(read.csv("../data/sackmann/2018-wimbledon-points.csv"))
...
wimbledon_2019_matches <- as.data.table(read.csv("../data/sackmann/2019-wimbledon-matches.csv"))
# names(wimbledon_2019_matches)
colSums(is.na(wimbledon_2019_matches))

wimbledon_2019_points <- as.data.table(read.csv("../data/sackmann/2019-wimbledon-points.csv"))
...
wimbledon_2021_matches <- as.data.table(read.csv("../data/sackmann/2021-wimbledon-matches.csv"))
# names(wimbledon_2021_matches)
colSums(is.na(wimbledon_2021_matches))

wimbledon_2021_points <- as.data.table(read.csv("../data/sackmann/2021-wimbledon-points.csv"))
...
wimbledon_2022_matches <- as.data.table(read.csv("../data/sackmann/2022-wimbledon-matches.csv"))
# names(wimbledon_2022_matches)
colSums(is.na(wimbledon_2022_matches))

wimbledon_2022_points <- as.data.table(read.csv("../data/sackmann/2022-wimbledon-points.csv"))
...
wimbledon_2023_matches <- as.data.table(read.csv("../data/sackmann/2023-wimbledon-matches.csv"))
# names(wimbledon_2023_matches)
colSums(is.na(wimbledon_2023_matches))

wimbledon_2023_points <- as.data.table(read.csv("../data/sackmann/2023-wimbledon-points.csv"))
...
wimbledon_2024_matches <- as.data.table(read.csv("../data/sackmann/2024-wimbledon-matches.csv"))
# names(wimbledon_2024_matches)
colSums(is.na(wimbledon_2024_matches))

wimbledon_2024_points <- as.data.table(read.csv("../data/sackmann/2024-wimbledon-points.csv"))
